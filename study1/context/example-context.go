...
root@pts/1 # ./context
sleepRandomContext Starting sleep for 185 ms
Main Starting sleep for 126 ms
Main Waking up, slept for  126 ms
Main sleepRandom complete
Main Sleep complete. canceling context
